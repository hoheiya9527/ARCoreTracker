package com.urovo.scanner.scanner.ar.scanarcore.tracker;
...
import com.urovo.scanner.scanner.ar.scanarcore.ar.ARCoreManager;
import com.urovo.scanner.scanner.ar.scanarcore.detector.BarcodeDetector;
import com.urovo.scanner.scanner.ar.scanarcore.model.BarcodeInfo;
import com.urovo.scanner.scanner.ar.scanarcore.model.LayoutPose;
import com.urovo.scanner.scanner.ar.scanarcore.pose.PoseEstimator;
...
public class BarcodeARTracker {
    ...
    public BarcodeARTracker(Context context, @NonNull ARCoreManager arCoreManager) {
        this.arCoreManager = arCoreManager;
        this.barcodeDetector = new BarcodeDetector(context);
